...
You need first to define the `relative-date-formats variable and specify how to format a date difference according to the amount of seconds separating the two date. 
